  ...
  return (
    <div>
      <div className="panel-header">
        <div className="panel-title">ბინები <span>{properties.length} განცხადება</span></div>
        ...
        <div className="modal-overlay" onClick={e => e.target === e.currentTarget && setShowModal(false)}>
          <div className="modal">
            ...
            <div className="modal-header">
              <div className="modal-title">{editing ? 'ბინის რედაქტირება' : 'ბინის დამატება'}</div>
            ...
            <div className="modal-body">
              ...
              <div className="form-grid" style={{marginBottom: '24px'}}>
                <div className="form-field">
                  ...
                  <input className="form-input" value={form.title.geo} onChange={e => bi('title','geo',e.target.value)} placeholder="ბინა ვაკეში" />
                </div>
                <div className="form-field">
                  <label className="form-label">English</label>
                  <input className="form-input" value={form.title.eng} onChange={e => bi('title','eng',e.target.value)} placeholder="Apartment in Vake" />
                </div>
                <div className="form-field" />
              </div>
              ...
              <div className="form-grid" style={{marginBottom: '24px'}}>
                <div className="form-field" style={{gridColumn: 'span 1'}}>
                  <label className="form-label">ქართული</label>
                  <textarea className="form-textarea" value={form.description.geo} onChange={e => bi('description','geo',e.target.value)} placeholder="ბინის აღწერა..." />
                </div>
                <div className="form-field" style={{gridColumn: 'span 1'}}>
                  <label className="form-label">English</label>
